...
def test_retriever_reranker(input_texts, params, n_documents, tmp_path):
...
def test_retriever_reranker_drop_duplicate(
    input_texts, drop_duplicates, n_retrieved_documents, tmp_path
):
...
def test_retriever_reranker_tags(tmp_path):
